...
[![Netlify Status](https://api.netlify.com/api/v1/badges/8d5b486d-1def-49b3-bd8f-b830579c19af/deploy-status)](https://app.netlify.com/sites/salafiblog/deploys)
...
[![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/AOMuiz/nLog&stack=cms)

Or access the following demo site:

[Next.js blog template for Netlify](https://salafiblog.netlify.app/)
...
- **TOC component**: extends content writing with React component like WordPress shortcodes
- **Support for multiple authors**
- **Mobile-friendly view**
- **Near perfect lighthouse score**: [Lighthouse score](https://www.webpagetest.org/result/221120_BiDcZT_RK/)
...
```
npx create-next-app your-blog --example "https://github.com/AOMuiz/nLog"
```
...
All source codes related to the blog are under [components](/src/components) and [pages](/pages) directory.
You can modify it freely if you want to apply your design theme.
All components use [styled-jsx](https://github.com/vercel/styled-jsx) and [styled-components](https://github.com/css-modules/css-modules) to define their styles, but you can choose any styling libraries for designing your theme.
...
- [src/lib/authors.js](/src/lib/authors.ts): fetches metadata and defines utility functions for components
- [meta/authors.yml](/src/meta/authors.yml): author content managed by Netlify CMS
- [src/components/PostLayout.js](/src/components/PostLayout.js): displays author content for each page

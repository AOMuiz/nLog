---
slug: "creating-a-custom-react-hook-for-markdown-parsing"
title: "Creating a custom react hook for markdown parsing"
date: 2022-02-11
author: AOMuiz
summary: "I am making a side project in React that requires markdown parsing so I decided to use that as a good candidate to experiment with custom hooks"
tags:
  - style
  - markdown
category: Snippets
